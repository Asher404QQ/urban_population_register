...
public class StudentOrderDaoImplTest {
    ...
    public StudentOrder buildStudentOrder(long id) {
        ...
        Address address = new Address("84004", new Street(1l, "First street"), "10", "2", "21");

        University h_university = new University(2L, "");
        Adult husband = new Adult("Орлов", "Сергей", "Михайлович", LocalDate.of(1989, 2, 24), address, "12346" + id, "4943",
        ...
        Child child1 = new Child("Орлова", "Анастасия", "Сергеевна", LocalDate.of(2008, 3, 5), address, "230984" + id, LocalDate.of(2012, 3, 7), register_office);
