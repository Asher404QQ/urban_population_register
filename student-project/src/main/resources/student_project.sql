...
create table jc_passport_office(
    ...
    p_office_area_id varchar(12) not null,
...
create table jc_register_office(
    ...
    r_office_area_id varchar(12) not null,
...
create table jc_student_order(
    ...
    h_passport_number varchar(4) not null,
    ...
    w_passport_number varchar(4) not null,
...
create table jc_student_child(
    ...
    c_certificate_data date not null,
